...
, stdenv ? pkgs.stdenv, buildRustCrateForPkgs ? if buildRustCrate != null then
  lib.warn "`buildRustCrate` is deprecated, use `buildRustCrateForPkgs` instead"
  (_: buildRustCrate)
else
  pkgs:
  pkgs.buildRustCrate
...
rec {
  ...
  workspaceMembers = {
    "lectev" = rec {
      packageId = "lectev";
      build = internal.buildRustCrateWithFeatures { packageId = "lectev"; };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bdays" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "1ynqbv9hmph3pljggwrsi6f47d0zmfj7h4dp10czv0qyqwhic39i";
      ...
      "chrono" = rec {
        ...
        resolvedDefaultFeatures =
          [ "clock" "default" "libc" "oldtime" "serde" "std" "time" "winapi" ];
      };
      "clap" = rec {
        crateName = "clap";
        version = "2.33.3";
      ...
      "csv-async" = rec {
        ...
        version = "1.2.1";
        edition = "2018";
        sha256 = "1bfrdgnz2zxfpbpdrr1k62wgvmfz2p40bwmcihqq0cv90rz7clf8";
      ...
      "hyper" = rec {
        ...
        version = "0.14.13";
        edition = "2018";
        sha256 = "14w5rnhy89jh3s4fl63i1x50gdh5nknmj7y00kx5b1pnwjwwzl8m";
        type = [ "lib" "staticlib" "cdylib" ];
        authors = [ "Sean McArthur <sean@seanmonstar.com>" ];
        dependencies = [
          {
            name = "bytes";
        ...
        resolvedDefaultFeatures =
          [ "client" "h2" "http1" "http2" "runtime" "socket2" "tcp" ];
      };
      "hyper-tls" = rec {
        crateName = "hyper-tls";
        version = "0.5.0";
        ...
        features = { "vendored" = [ "native-tls/vendored" ]; };
      };
      "idna" = rec {
        crateName = "idna";
        version = "0.2.3";
      ...
      "mio 0.7.13" = rec {
        ...
        resolvedDefaultFeatures =
          [ "default" "net" "os-ext" "os-poll" "os-util" "tcp" "udp" "uds" ];
      };
      "mio-uds" = rec {
        crateName = "mio-uds";
        version = "0.6.8";
      ...
      "pest" = rec {
        ...
        features = { "pretty-print" = [ "serde" "serde_json" ]; };
      };
      "pin-project" = rec {
      ...
      "reqwest" = rec {
        ...
        devDependencies = [
          {
            ...
            target = { target, features }: (!(target."arch" == "wasm32"));
            features =
              [ "tcp" "stream" "http1" "http2" "client" "server" "runtime" ];
          }
          {
            name = "serde";
            packageId = "serde";
        ...
        features = {
          ...
          "blocking" =
            [ "futures-util/io" "tokio/rt-multi-thread" "tokio/sync" ];
          "brotli" =
            [ "async-compression" "async-compression/brotli" "tokio-util" ];
          "cookies" = [ "cookie_crate" "cookie_store" "time" ];
          "default" = [ "default-tls" ];
          "default-tls" =
            [ "hyper-tls" "native-tls-crate" "__tls" "tokio-native-tls" ];
          "deflate" =
            [ "async-compression" "async-compression/zlib" "tokio-util" ];
          "gzip" =
            [ "async-compression" "async-compression/gzip" "tokio-util" ];
          "json" = [ "serde_json" ];
      ...
      "semver 0.11.0" = rec {
        ...
        features = { "ci" = [ "serde" "diesel/sqlite" ]; };
        resolvedDefaultFeatures = [ "default" ];
      };
      "semver 0.9.0" = rec {
        crateName = "semver";
      ...
      "snafu" = rec {
        ...
        features = {
          ...
          "unstable-backtraces-impl-std" =
            [ "backtraces" "snafu-derive/unstable-backtraces-impl-std" ];
        };
      ...
      "tracing-appender" = rec {
        ...
        version = "0.1.2";
        edition = "2018";
        sha256 = "0yhjnx2gap7qpjmhrngd66nan8hj2cqkx8rj2j8ch4kza1z50rcr";
        authors = [
      ...
      "tracing-futures" = rec {
        ...
        resolvedDefaultFeatures =
          [ "default" "pin-project" "std" "std-future" "tokio" ];
      };
      "tracing-log" = rec {
      ...
      "uom" = rec {
        ...
        version = "0.31.1";
        edition = "2018";
        sha256 = "0dwih0bclq18gfdf7if6kqip82w8yrf076l0ad1n3gr71bynpvmi";
      ...
      "wasm-bindgen-futures" = rec {
        ...
        features = { "futures-core-03-stream" = [ "futures-core" ]; };
      };
