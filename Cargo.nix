  ...
  internal = rec {
    ...
    crates = {
      ...
      "backoff" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "futures" "futures-core" "pin-project" "tokio" "tokio_1" ];
      };
      "base64" = rec {
        crateName = "base64";
        version = "0.13.0";
      ...
      "csv-async" = rec {
        ...
        authors = [
          "gwierzchowski <gwierzchowski@wp.pl>"
        ];
        dependencies = [
          {
            name = "bstr";
        ...
        resolvedDefaultFeatures = [ "default" "itoa" "ryu" "serde" "tokio" "tokio-stream" "tokio1" "with_serde" ];
      };
      "csv-core" = rec {
        crateName = "csv-core";
        version = "0.1.10";
      ...
      "lectev" = rec {
        ...
        edition = "2018";
        crateBin = [
          { name = "lectev"; path = "src/main.rs"; }
        ];
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./.; };
        authors = [
          "Eric B. Merritt <eric@merritt.tech>"
        ];
        dependencies = [
          {
            name = "assoc";
      ...
      "percentage-rs" = rec {
        ...
        authors = [
          "NemuiSen <nekonya.sen@gmail.com>"
        ];
        dependencies = [
          {
            name = "num-traits";
      ...
      "tracing-futures" = rec {
        ...
        resolvedDefaultFeatures = [ "default" "pin-project" "std" "std-future" "tokio" ];
      };
      "tracing-log" = rec {
      ...
      "uom" = rec {
        ...
        resolvedDefaultFeatures = [ "autoconvert" "default" "f32" "f64" "serde" "si" "std" "use_serde" ];
      };
      "url" = rec {
        crateName = "url";
        version = "2.2.2";
      ...
      "winapi 0.3.9" = rec {
        ...
        resolvedDefaultFeatures = [ "cfg" "consoleapi" "errhandlingapi" "evntrace" "fileapi" "handleapi" "impl-debug" "impl-default" "in6addr" "inaddr" "ioapiset" "knownfolders" "lmcons" "minschannel" "minwinbase" "minwindef" "mstcpip" "mswsock" "namedpipeapi" "ntdef" "ntsecapi" "ntstatus" "objbase" "processenv" "profileapi" "schannel" "securitybaseapi" "shlobj" "sspi" "std" "synchapi" "sysinfoapi" "threadpoollegacyapiset" "timezoneapi" "winbase" "wincrypt" "windef" "winerror" "winioctl" "winnt" "winreg" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
